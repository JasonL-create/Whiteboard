...
function renderShell(){
 ...
 $('#masterNav').innerHTML=`<div class="master-left"><button id="projectsNav" class="nav-btn ${view==='board'&&filter!=='archived'?'selected':''}"><img class="nav-icon-img" src="icon-projects.png" alt="">PROJECTS</button><button id="keysNav" class="nav-btn ${view==='keys'?'selected':''}"><img class="nav-icon-img" src="icon-keys.png" alt="">KEYS</button><button id="archiveNav" class="nav-btn ${view==='board'&&filter==='archived'?'selected':''}"><img class="nav-icon-img" src="icon-archive.png" alt="">ARCHIVE <b>${arch}</b></button><button id="reportsNav" class="nav-btn ${view==='reports'?'selected':''}"><img class="nav-icon-img" src="icon-reports.png" alt="">REPORTS</button><button id="settingsNav" class="nav-btn ${view==='settings'?'selected':''}"><img class="nav-icon-img" src="icon-configure.png" alt="">CONFIGURE</button></div>`;
 ...
 if(view==='keys'){
   ...
   hero.innerHTML=`<div class="context-left"><button id="addKeyTagHero" class="hero-add">Add New Key Tag</button><button id="allKeysFilter" class="filter-btn ${keyFilter==='all'?'active':''}">ALL <b>${keys.length}</b></button><button id="lbOutFilter" class="filter-btn ${keyFilter==='lb'?'active':''}">LB OUT <b>${lbOut}</b></button><button id="keysOutFilter" class="filter-btn ${keyFilter==='keys'?'active':''}">KEYS OUT <b>${out}</b></button><div class="nav-dropdown"><button class="filter-btn ${keySort!=='tag'?'active':''}">SORT BY</button><div class="dropdown-panel"><button data-key-sort="tag">TAG NUMBER</button><button data-key-sort="address">PROPERTY ADDRESS</button><button data-key-sort="available">AVAILABLE FIRST</button><button data-key-sort="assigned">ASSIGNED FIRST</button><button data-key-sort="missing-key">MISSING KEYS FIRST</button><button data-key-sort="missing-lb">MISSING LB FIRST</button></div></div></div>${heroSearch}`;
