...
function renderShell(){
 ...
 $('#masterNav').innerHTML=`<div class="master-left"><button id="projectsNav" class="nav-btn ${view==='board'&&filter!=='archived'?'selected':''}"><img class="nav-icon-img" src="icon-projects.png" alt="">PROJECTS</button><button id="keysNav" class="nav-btn ${view==='keys'?'selected':''}"><img class="nav-icon-img" src="icon-keys.png" alt="">KEYS</button><button id="archiveNav" class="nav-btn ${filter==='archived'?'selected':''}"><img class="nav-icon-img" src="icon-archive.png" alt="">ARCHIVE <b>${arch}</b></button><button class="nav-btn future-nav" disabled><img class="nav-icon-img" src="icon-reports.png" alt="">REPORTS</button><button id="settingsNav" class="nav-btn ${view==='settings'?'selected':''}"><img class="nav-icon-img" src="icon-configure.png" alt="">CONFIGURE</button></div><div class="master-search"><div class="search-wrap"><span class="search-icon"></span><input id="shellSearch" class="shell-search" type="search" placeholder="Search" value="${q}"></div></div>`;
