...
function reconcileTurnProcess(process=[]){
 ...
 const order=['Tenant Gave Notice','Sent Confirmation','Owner Notified','Scheduled Move Out','Keys Returned','Transfer Utilities','MOI','Mailed Disposition','PMI','Listed'];
