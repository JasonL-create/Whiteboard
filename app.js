...
function lifecycleDefaults(type){return type==='turn'?{enabled:false,date:'',occupancy:'',steps:{notifyTenants:false,deleteActivity:false,utilitiesCanceled:false,setMaFeeZero:false,setReserveZero:false,hideProperty:false},na:{}}:{enabled:false,date:'',occupancy:'',steps:{createOwner:false,createProperty:false,addTenants:false,transferUtilities:false,createDropbox:false,notifyNewTenants:false,collectKeys:false,collectSd:false,addTenantActivities:false},na:{}}}
