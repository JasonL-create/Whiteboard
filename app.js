...
function renderSettings(){
  ...
  renderShell();
  const hero=$('#pageHero');
  hero.innerHTML=`<div><h1>Configure</h1></div>`;
  $('#contextNav').innerHTML='';
  const used=usedLBs();
